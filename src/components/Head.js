...
import imageBg from "@/images/svg/bg-1.svg";
import noData from "@/images/svg/no-data.svg";
...
const Head = () => {
  ...
  const styleBg = {
    // backgroundColor: "#f8fcffbd",
  };

  return (
    <section class="">
      <div className="absolute top-0 w-[90%] right-[12px] z-[-1]">
        <img src={imageBg} alt="camera" className="" />
      </div>
      <div class="flex flex-col gap-[40px]">
        <div class="flex flex-col items-center gap-[24px] mt-[164px]">
          <h2 style={styleTitle} class="max-w-[1000px] mx-24px sm:mx-[122px] text-4xl text-center font-extrabold tracking-tight leading-none md:text-5xl xl:text-5xl 
          ...
          <p class="font-light text-gray-500 text-center max-w-[1200px] mx-24px sm:mx-[122px]">
        ...
        <div style={styleBg} className="flex flex-col items-center justify-center w-full py-[40px]">
          <div className="flex flex-col items-center justify-center">
            <h3 className="font-bold text-xl text-yellowSea">Trouver votre formation</h3>
      ...
      dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
            ...
            <div className="">
              {!publicites.length ? (<img src={noData} alt="camera" className="" />) : (
                <div style={slid}>
                  {publicites.length > 1 ? (
